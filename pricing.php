            ...
            <div class="container container-1600 bg-dot-left-bottom">
                ...
                <div class="header-style-2 text-center animate" data-animate="fadeInUp">
                    ...
                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been
                        the industry's standard dummy text ever since the 1500 when an unknown .</p>
                </div>
                ...
                <div class="section-content">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="pricing-plans pricing-plan text-center animate" data-animate="fadeInUp"
                                id="pricing-slider">
                                <div class="pricing-plan pp1 pricing-plan-item active" id="one">
                                    ...
                                    <div class="desc">Our monthly subscription covers the LNS API for one location and
                                        one POS device.</div>
                                </div>
                ...
                <div class="container container-1600">
                    ...
                    <div class="header-style-2 text-center animate" data-animate="fadeInUp">
                        ...
                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has
                            been the industry's standard dummy text ever since the 1500 when an unknown. Lorem Ipsum is
                            simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the
                            industry's standard dummy text ever since the 1500 when an unknown .</p>
                    </div>

                    <div class="section-content">
                        <div class="row">
                            <div class="col-12 col-lg-5 text-center order-lg-2 animate" data-animate="fadeInRight">
                                <img src="assets/img/new-images/faq.png" width="260" height="550" class="img-fluid"
                                    alt="" />
                            </div>
                            <div class="col-12 col-lg-5 offset-lg-1 order-lg-1">
                                ...
                                <div class="faq-accordion accordion animate" id="accordion" data-animate="fadeInUp">
                                    ...
                                    <div class="accordion-item active">
                                        <h5 class="accordion-title">Lorem Ipsum Dolor Sit</h5>
