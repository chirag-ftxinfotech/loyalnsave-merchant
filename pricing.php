                    ...
                    <div class="col-12 col-xl-8 offset-xl-2">
                        ...
                        <div class="pricing-plans text-center">
                            <div class="pricing-plan pp1">
                                ...
                                <div class="desc">Our monthly subscription covers the LNS API for one location and one POS device.</div>
                            </div>
    ...
    <section class="section section-bg">
        <div class="container container-1600">
            ...
            <div class="header-style-2 text-center">
                ...
                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500 when an unknown. Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500 when an unknown .</p>
            </div>
            ...
            <div class="section-content">
                <div class="row align-items-center">
                    ...
                    <div class="col-12 col-xl-5 text-center">
                        <img src="assets/img/new-images/faq.png" alt="" />
                    </div>
                </div>
            </div>
