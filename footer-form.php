<section class="section-getintouch">
    <div class="sg-image">
        <img src="assets/img/new/dashboard.png" alt="" />
    </div>
    <div class="container">
        <div class="row">
            <div class="col-24 col-lg-10">
                ...
                <div class="form">
                    ...
                    <p>Fill out the form below for our product demo.</p>
                    ...
                    <div class="form-field">
                        <input type="text" required class="form-control" placeholder="Business Name" />
                    </div>
                    <div class="form-field">
                        <input type="text" required class="form-control" placeholder="Email Address" />
                    </div>
                    <div class="form-field">
...
<footer id="footer" class="footer-home animated-row">
            ...
            <div class="row">
                <div class="col-24">
                    <div class="footer-middle">
                        <div class="row">
                            <div class="col-24 col-lg-24 col-xl-6 text-center">
                                <a href="#" class="f-logo"><img src="assets/img/new/f-logo.png" /></a>
                            </div>
                            <div class="col-24 col-lg-24 col-xl-12">
                                <div class="row">                        
                            ...
                            <div class="col-24 col-lg-24 col-xl-6">
                                ...
                                <div class="f-block f-support no-accordion">
        ...
        <div class="modal-content">
            <div class="modal-body">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><svg
                        class="svg svg-modal-close" aria-hidden="true" role="img">
                        <use href="#svg-modal-close" xmlns:xlink="http://www.w3.org/1999/xlink"
                            xlink:href="#svg-modal-close"></use>
                    </svg></button>
