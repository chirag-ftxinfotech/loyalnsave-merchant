            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-6 pl-0">
                        <img src="assets/img/new-images/deals-phone.png" class="img-fluid" width="960" height="693" alt="">
                    </div>
                ...
                <div class="row mt-lg-5">
                    ...
                    <div class="col-md-3 px-0">
                        <div class="feature-item animate ">
                            <div class="thumb-container">
                                <p class="thumb">
                                    <img src="assets/img/new-images/deal-icon2.png" width="50" height="50" alt="" />
                                </p>
                            </div>
                            <h4>Lorem Ipsum</h4>
            ...
            <div class="container mt-lg-5">
                <div class="row">
                    <div class="col-md-6 pl-0 order-md-2">
                        <img src="assets/img/new-images/deals-girl.png" class="img-fluid" width="960" height="693" alt="">
                    </div>
