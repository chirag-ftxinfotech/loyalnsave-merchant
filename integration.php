    ...
    <main id="content">
        ...
        <section class="header-app inner">
            ...
            <div class="header__img_bottom text-center">
                <img src="assets/img/new/integration.png" alt="" />
            </div>
        </section>
        <!-- Waves -->
            ...
            <div class="container">
                <div class="row align-items-center rs-section">                    
                    ...
                    <div class="col-24 col-md-10 offset-md-1 rs-text">
                        <div class="header-title-1">
                            <h3 class="title">Developer Driven</h3>
        ...
        <section class="section-i4">
            <div class="container">
                ...
                <div class="header-title-1 text-center">
                    <h3 class="title">Loyal~n~Save API is the Solution You Need</h3>
                </div>
                    ...
                    <div class="col-20 offset-3 col-md-14 offset-md-5 col-lg-7 offset-lg-1">
                        <div class="apis-items apis-items-1">
                            ...
                            <div class="apisi-inner">
                                ...
                                <p>Your customer's information easily gathered and stored all in one location for use in targeted campaigns.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-20 offset-3 col-md-14 offset-md-5 col-lg-7 offset-lg-1">
                            ...
                            <div class="program-item program-1">
                                <div class="program-inner">
                                    ...
                                    <div class="text">
                                        ...
                                        <p>If you are a small hometown business and don't have a tech team, we do offer assistance to get your Loyal~n~Save API customized to fit your level of business and fully integrated within your already existing POS system.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="program-item program-2">
                                <div class="program-inner">
                                    ...
                                    <div class="text">
                                        ...
                                        <p>We have years of experience in working with chain stores of over 60 locations in integrating the Loyal~n~Save API into their POS system. We provide all of the necessary integration pieces and can assist your tech team if any bugs should occur.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="program-item program-3">
                                <div class="program-inner">
                                    ...
                                    <div class="text">
                                        ...
                                        <p>Not only will your business have an easy-to-use interface, but your customers will have access to a user-friendly smartphone app allowing them to check their point balances, participate in your store's deals, and refer their friends and family to your business.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
