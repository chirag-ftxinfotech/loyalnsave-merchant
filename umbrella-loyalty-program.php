...
<body>
    ...
    <main id="content">
        ...
        <section class="section-waves section-blue">
            <div class="container">
                <div class="header-title-1 text-center">
                    <h3 class="title">How an Umbrella Loyalty Program <br />Can help your small to medium sized business? </h3>
                ...
                <div class="row align-items-center rs-section">                    
                    ...
                    <div class="col-24 col-md-10 offset-md-1 rs-text">
                        <div class="header-title-1">
                            <h3 class="title">What types of brands are best to Partner under an umbrella?</h3>
            ...
            <div class="container">
                <div class="row align-items-center rs-section">
                    <div class="col-24 col-md-10 rs-text">
                        <div class="header-title-1">
                            <h3 class="title">Manage loyalty in a multi-brand organization </h3>
        ...
        <section class="section-waves section-light">
            <div class="container">
                <div class="row align-items-center rs-section">                    
                    ...
                    <div class="col-24 col-md-10 offset-md-1 rs-text">
                        <div class="header-title-1">
                            <h3 class="title">How to increase Customer Lifetime Value (CLV) through Umbrella loyalty Program?</h3>
        ...
        <section class="section-content">
            <div class="container">
                <div class="header-title-1 text-center">                            
                    <h3 class="title">Loyalty Solutions for Industrial Suppliers</h3>
                ...
                <div class="check-cards">
                    <div class="check-card col-md-6">
                        <div class="check-inner">
                            <h4>The Brand movers Loyalty and Rewards Platform </h4>
                        </div>
                    </div>
                    <div class="check-card col-md-6">
                        <div class="check-inner">
                            <h4>Easily Integrate & Scale</h4>
                        </div>
                    </div>
                    <div class="check-card col-md-6">
                        <div class="check-inner">
                            <h4>Flexible & Multifunctional Program</h4>
                        </div>
                    </div>
                    <div class="check-card col-md-6">
                        <div class="check-inner">
                            <h4>Provide Valuable Rewards, Rebates, & Partner Incentives</h4>
                        </div>
                    </div>
                </div>
            </div>
