...
<body>
    ...
    <main id="content">
        ...
        <section class="section bg-dot-right-top bg-dot-left-top gamification-top animated-row">
            <div class="container bg-dot-left-bottom">
                <div class="header-style-2 animate" data-animate="fadeInUp">
                    ...
                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been
                        ...
                        since the 1500 when an unknown printer took a galley of type and scrambled it to make a type
                        specimen book.<br /><br />Lorem Ipsum has been the industry's standard dummy text ever since the
                        1500 when an unknown printer took a galley of type and crambled it to make a type specimen book.
                    </p>
                </div>

                <div class="section-content animate" data-animate="fadeInUp">
                    <div class="gamification-items">
        ...
        <section class="section curved-section curved-theme mt-0 animated-row">
            <div class="curved-inner">
                <div class="container">
                    <div class="section-content">
                        <div class="row align-items-center">
                            <div class="col-12 col-xl-7 animate" data-animate="fadeInLeft">
                                <div class="img-tooltip mt-md-5 mx-auto">
                                    ...
                                    <div class="media img-tooltip-item img-tooltip-item--left--top">
                                        <img src="assets/img/new-images/lns-logo-small.png" alt="" width="80"
                                            height="80">
                                        <div class="media-body">01. Lorem Ipsum is simply dummy text</div>
                                    </div>
                                    <div class="media img-tooltip-item img-tooltip-item--right--center">
                                        <img src="assets/img/new-images/lns-logo-small.png" alt="" width="80"
                                            height="80">
                                        <div class="media-body">03. Lorem Ipsum is simply dummy text</div>
                                    </div>
                                    <div class="media img-tooltip-item img-tooltip-item--left--bottom">
                                        <img src="assets/img/new-images/lns-logo-small.png" alt="" width="80"
                                            height="80">
                                        <div class="media-body">02. Lorem Ipsum is simply dummy text</div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-xl-5 animate" data-animate="fadeInRight">
                                <div class="header-style-2">
                                    <h3 class="sub-title">Lorem Ipsum Dolor Sit</h3>
                                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
                                        Ipsum has been the industry's standard dummy text ever since the 1500.</p>
                                </div>
                                <div class="section-content">
                                    <div class="v-steps-items">
                                        <div class="v-steps-item">
                                            <i class="icon"><img src="http://placehold.it/32" alt="" /></i>
                                            <h5 class="title">Lorem Ipsum</h5>
                                            <p class="desc">Lorem Ipsum is simply dummy text of the printing and
                                                typesetting industry. Lorem standard dummy text.</p>
                                        </div>
                                        <div class="v-steps-item">
                                            <i class="icon"><img src="http://placehold.it/32" alt="" /></i>
                                            <h5 class="title">Lorem Ipsum</h5>
        ...
        <section class="section py-0 animated-row">
            <div class="container">
                <div class="section-content">
                    <div class="row align-items-center">
                        <div class="col-12 col-xl-8 animate" data-animate="fadeInLeft">
                            <div class="header-style-2">
                                <h3 class="sub-title">Lorem Ipsum Dolor Sit</h3>
                                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
                                    Ipsum has been the industry's standard dummy text ever since the 1500. Lorem Ipsum
                                    is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been
                                    the industry's standard dummy text ever since the 1500.<br /><br />Lorem Ipsum is
                        ...
                        <div class="section-content col-12 d-flex pl-lg-5 animate" data-animate="fadeInUp">
        ...
        <section class="section curved-section curved-theme mt-0 below-quote-img pb-0 animated-row">
            <div class="curved-inner">
                <div class="container">
                    <div class="section-content">
                        <div class="row align-items-center">
                            <div class="col-12 col-xl-6 animate" data-animate="fadeInLeft">
                            ...
                            <div class="col-12 col-xl-5 animate" data-animate="fadeInRight">
                                <div class="header-style-2">
                                    ...
                                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
                                        ...
                                        1500.<br /><br />Lorem Ipsum is simply dummy text of the printing and
                                        typesetting industry. Lorem Ipsum has been the industry'.<br /><br />Lorem Ipsum
                                        is simply dummy text of the printing and typesetting industry. Lorem Ipsum has
                                        been the industry'.<br /><br />Lorem Ipsum is simply dummy text of the printing.
                                    </p>
                                </div>
                            </div>
                        </div>
        ...
        <section class="clientsay-section animated-row">
            <div class="container">
                <div class="row">
                    <div class="header-style-2 text-center animate col-12 animate" data-animate="fadeInUp">
